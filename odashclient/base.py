...
from odashclient import conf
from odashclient.helpers import construct_checksum, varmap, transform, get_installed_apps, urlread

logger = logging.getLogger('odashclient.errors')

class OdashClient(object):
    def process(self, **kwargs):
        from odashclient.helpers import get_filters
    ...
    def send(self, **kwargs):
        project = conf.ODASH_PROJECT_NAME
        site = conf.ODASH_SITE_NAME
        extra = dict( 
                     site=site,
                     project=project,
        )
